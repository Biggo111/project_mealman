...
class _GridviewItemState extends State<GridviewItem> {
  ...
  List services = ["Restaurants", "Home Catering","Favourites", "Reservation"];

  List servicesDescription = ["Order in your desired restaurents", "Catering from our students", "Browse from your favourites", "Reserve a restaurant"];
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: AssetImage(slidingImageList[widget.index]["image_path"]),
                  fit: BoxFit.cover,
                ),
                ),
              ),
